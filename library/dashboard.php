                ...
                <div class="card o-hidden">
                   <div class="chart-widget-top">
                     <div class="row card-body">
                       <div class="col-5">
                         <h6 class="f-w-600 font-primary">TOTAL STUDENTS</h6><span class="num"><span class="counter">90</span>%<i class="icon-angle-up f-12"></i></span>
                       </div>
                       <div class="col-7 text-end">
                         <h4 class="num total-value"> <span class="counter"><?php echo $num ?></span></h4>
                       </div>
                     </div>
                     <div>
             ...
             <div class="col-md-4">
               <div class="card o-hidden">
                  <div class="chart-widget-top">
                    <div class="row card-body">
                      <div class="col-5">
                        <h6 class="f-w-600 font-primary">TOTAL BOOKS</h6><span class="num"><span class="counter">87</span>%<i class="icon-angle-up f-12"></i></span>
                      </div>
                      <div class="col-7 text-end">
                        <h4 class="num total-value"> <span class="counter"><?php echo $num1 ?></span></h4>
                      </div>
                    </div>
                    <div>
